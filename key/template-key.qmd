...
*If we don't replace the values we run out of options to choose. If we only have 5 balls in the urn once we pull out all 5 we can't resample. If we keep putting them back we can go on forever*
